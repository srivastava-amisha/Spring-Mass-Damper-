...
plt.ion() # for interactive drawing


class dataPlotter:
    '''
        This class plots the time histories of spring mass system
    '''
    ...
    def __init__(self):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax[0],ylabel='z(m)',title='Mass spring data'))
    ...
    def update(self,t,reference,states,ctrl):
        ...
        # update the plots with associayed histories
